      ...
      <div class="flex items-center h-full">
        ...
        >
          ...
          <div 
            ...
            style="background-color: var(--bg-color); border: 1px solid var(--border-color); border-top: none;"
            @mousedown.stop
          >
            <template v-for="(item, idx) in menu.items" :key="idx">
              ...
              >
                ...
                <span class="text-[10px] opacity-50 group-hover:opacity-100 ml-4">{{ item.shortcut || '' }}</span>
              </div>
            </template>
          </div>
        </div>
